  ...
  return (
    <div className="relative mt-2 w-full min-w-[100px]">
      <textarea
        id={id}
        type={type}
        className={`peer h-full w-full rounded-md border border-gray-200 bg-transparent bg-white px-3 py-3 font-sans text-sm font-normal text-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-gray-200 placeholder-shown:border-t-gray-200 focus:border-2 focus:border-zinc-500 focus:border-t-transparent focus:outline-0 ${className}`}
        ref={ref}
        rows={rows}
        {...props}
      />
    ...
    return (
      <div className="relative mt-2 w-full min-w-[100px]">
        <textarea
          ...
          }  bg-white px-3 py-3 font-sans text-sm font-normal text-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-gray-200 placeholder-shown:border-t-gray-200 focus:border-2 focus:border-zinc-500 focus:border-t-transparent focus:outline-0 ${className}`}
          ref={ref}
          onInput={handleInput}
          rows={rows}
          {...props}
        ...
        {label && (
          <label
            className={`before:content[' '] after:content[' '] before:border-gray-200 after:border-gray-200 peer-placeholder-shown:text-gray-500 pointer-events-none absolute -top-1.5 left-0 flex h-full w-full select-none !overflow-visible truncate text-[12px] font-normal leading-tight ${
